...
const translations = {
  es: {
    ...
    "hero.title": "Desarrollo experiencias web<br>modernas, funcionales y<br><em>pensadas para resolver<br>problemas reales.</em>",
    ...
    "about.title": "Daniel Díaz<br><em>Canosa.</em>",
  ...
  en: {
    ...
    "hero.title": "I build modern, functional<br>web experiences<br><em>designed to solve<br>real problems.</em>",
  ...
  pt: {
    ...
    "hero.title": "Desenvolvo experiências web<br>modernas, funcionais e<br><em>pensadas para resolver<br>problemas reais.</em>",
